            ...
            if (arg1.length < 1) {
                if (!Utils.inDungeons) {
                    player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                            + "FDH: Use this command in dungeons or run \"/room help\" for additional options"));
                    return;
                }
                ...
                if (blockFrequencies == null) {
                    player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                            + "FDH: Make sure you aren't in a hallway between rooms and that your render distance is high enough."));
                    return;
                }
                ...
                switch (arg1[0].toLowerCase()) {
                    ...
                    case "open":
                        if (!Utils.inDungeons) {
                            player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                    + "FDH: Use this command in dungeons"));
                            return;
                        }
                    ...
                    case "set":
                        switch (arg1[1].toLowerCase()) {
                            ...
                            default:
                                player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                        + "FDH: Valid options are <gui | dsg | sbp>"));
                                break;
                        }
                        break;
                    ...
                    case "toggle":
                        String toggleHelp = "\n" + EnumChatFormatting.GOLD + " FakepixelDungeonHelper Mod Toggle Commands:" + "\n" +
                    ...
                    case "discord":
                        try {
                            player.addChatMessage(new ChatComponentText("FDH: Opening Fakepixel Discord invite in browser..."));
                    ...
                    case "coord":
                        if(Utils.originBlock == null) {
                            DungeonRooms.logger.warn("FDH: originBlock is null");
                            return;
                        }
                    ...
                    case "add":
                        ...
                        switch (arg1[1].toLowerCase()) {
                            ...
                            default:
                                player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                        + "FDH: Valid options are <chest | wither | superboom | lever | fairysoul | item | entrance | bat>"));
                                break;
                        }
                        break;
                    default:
                        player.addChatMessage(new ChatComponentText(EnumChatFormatting.RED
                                + "FDH: Run \"/room\" by itself to see the room name or run \"/room help\" for additional options"));
                }
            }
        }).start();
    }
